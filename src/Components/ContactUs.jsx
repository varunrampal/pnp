  ...
  <div class="container">
      <div class="row g-5">
          <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
              ...
              <h2 class="display-5 mb-5">If You Have Any Query, Please Contact Peels Native Plants Ltd</h2>
          ...
          <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s" style={{minHeight:'450px', border:'0'}}>
              <div class="position-relative rounded overflow-hidden h-100">
                  ...
                  title="Peels Native Plants Location"  src="https://www.google.com/maps?q=24095+65+Ave,+Langley+Twp,+BC,+V2Y+2H1&amp;output=embed"
