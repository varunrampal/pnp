...
$details = ['Name'=>$fullName, 'Company'=>$company ?: 'Not provided', 'Email'=>$email, 'Phone'=>text_value($body, 'phone', 60) ?: 'Not provided', 'Project location'=>text_value($body, 'location', 160) ?: 'Not provided', 'Required timing'=>text_value($body, 'requiredBy', 80) ?: 'Not provided', 'Plant list'=>$plantList ?: 'See attached plant list', 'Project notes'=>$projectNotes ?: 'Not provided'];
...
$customerDetails = ['Project location'=>text_value($body, 'location', 160) ?: 'Not provided', 'Required timing'=>text_value($body, 'requiredBy', 80) ?: 'Not provided', 'Plant list'=>$plantList ?: 'Attached to your request', 'Project notes'=>$projectNotes ?: 'Not provided'];
