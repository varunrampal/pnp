...
$payload = ['from'=>$fromName.' <'.$fromEmail.'>', 'to'=>[$recipient], 'reply_to'=>$email, 'subject'=>'New quote request — '.($company ?: $fullName), 'html'=>'<div style="font-family:Arial,sans-serif;line-height:1.6;color:#26352d"><h2>New PEELS website quote request</h2><table style="border-collapse:collapse">'.$rows.'</table><h3>Plant list</h3>'.$plantTable.$emailSignature.'</div>'];
